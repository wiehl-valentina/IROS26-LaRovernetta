...
def build_bev_observations(
    ...
    """
    Build BEV observations from the provided configuration and observation data.
    """
...
def run_offline_path_planner(
    ...
    """
    Pipeline de planificación de ruta "offline"
    Actividades:
    1. Construye las observaciones BEV a partir de la configuración y los datos de observación proporcionados.
    2. Fusiona las observaciones BEV en un marco local fijo alrededor de la pose de referencia.
    3. Planifica una ruta en el mapa de costos BEV fusionado hacia la meta especificada.

    """

    # Parse the observation configurations from the provided inputs and configuration from CLI
    ...
    # Construir las observaciones BEV a partir de la configuración y los datos de observación proporcionados
