...
{"waypoints": [...]}, guardados en genie/rutas/) y sus .geojson equivalentes.
...
# genie/genie_rover/route.py -> raiz del repo / carpeta genie
REPO_ROOT = Path(__file__).resolve().parents[2]
RUTAS_DIR = Path(__file__).resolve().parents[1] / "rutas"    # genie/rutas
