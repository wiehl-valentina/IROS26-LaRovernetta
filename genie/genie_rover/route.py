...
oficiales. Pensada para los archivos de genie/mexico_checkpoints_help/
(formato {"waypoints": [...]}) y sus .geojson equivalentes.
...
No depende de nada del bridge (numpy puro), asi que se prueba offline con
